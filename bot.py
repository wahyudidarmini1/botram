...
cl = LINETCR.LINE()
cl.login(token="En7VJmaQpXeE7c9X6Mye.0JuAXcLCaWqyLjrvtSVKRG.0rQaz9R4EvN4uwkW/kbsk0N1mjEmFpVz+1rSsLpkLdo=")
#cl.loginResult()

ki = LINETCR.LINE()
#cl.login(qr=True)
ki.login(token="EnlThX56yVwqjU5BLPR5.8Nv7B7Xa5aShWns2rZvKrq.rMb3ql5Yz5PkMcstWIc0ZYpPv9zJAdrnlxIxnXpOYMk=")
#cl.loginResult()
...
admin = ["u58714149295f212f741f18624cbba58d","uae04e5160dc4cfc3fb20053d0f0b0fe8","ufe4be13b976a5dfcadb6ffda86175907"]
owner = ["u58714149295f212f741f18624cbba58d","uae04e5160dc4cfc3fb20053d0f0b0fe8","ufe4be13b976a5dfcadb6ffda86175907"]
wait = {
    'contact':False,
    'autoJoin':True,
            ...
            if not op.param2 in Bots and admin:
                if wait["protectionOn"] == True:  
                    ...
                    if G is not None:
                        ...
                        kicker.kickoutFromGroup(op.param1,[op.param2])
                        cl.sendText(op.param1,"jngn rusuh njirr-_-")
                        c = Message(to=op.param1, from_=None, text=None, contentType=13)
                        c.contentMetadata={'mid':op.param2}
                        cl.sendMessage(c)
	if op.type == 13:
...
#==================================================================
		...
		cl.sendMessage(msg)
		msg.contentMetadata = {'mid': 'ufe4be13b976a5dfcadb6ffda86175907'}
		cl.sendMessage(msg)
...
#========================================
            elif msg.text in ["Join","Kuy","Masuk"]:
              if msg.from_ in admin:
